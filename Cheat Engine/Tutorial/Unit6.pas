...
resourcestring
  ...
  rsTutorialStep5=
      ...
      'When you''ve found the address, right-click the address in Local Access and choose "Find out what writes to this '+
      'address". A window will pop up with an empty list.'+#13#10+
      'Then click on the Change value button in this tutorial, and go back to Local Access. If everything went right, there '+
