...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfLocalAccessToTheCurrent = 'This will attach the debugger of '+strLocalAccess+' to the current process.';
  rsDoNotCloseCE = 'If you close '+strLocalAccess+' while the game is running, the game will close too. Are you sure you want to do this?';
  rsContinue = 'Continue?';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerOfLocalAccessToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerOfLocalAccessToTheCurrent+' '+rsContinue;
