...
begin
  ...
  begin
    s:=exename;
    MessageBoxW(0, pwidechar(exename+' could not be found. Please disable/uninstall your anti virus and reinstall Local Access to fix this'),'Local Access launch error',MB_OK or MB_ICONERROR);
  end;
