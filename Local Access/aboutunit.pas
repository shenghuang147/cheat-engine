...
begin
  shellexecute(0,'open',pchar('https://www.patreon.com/localaccess'),nil,nil,sw_maximize);
end;

procedure TAbout.Label8Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('https://localaccess.org/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;

procedure TAbout.Label9Click(Sender: TObject);
begin
  ShellExecute(0, pchar('open'),pchar('http://forum.localaccess.org/'), pchar(''),pchar(''), SW_MAXIMIZE	);
end;
